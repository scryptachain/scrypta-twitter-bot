<template>
  <div id="app">
      ...
      >
        <div class="container header">
          ...
          <a class="navbar-brand" href="/">
            <img src="assets/images/logo_white.png" alt="Scrypta">
          </a>
          ...
          <ul class="navbar-nav items">
            <li class="nav-item dropdown">
              <a href="#header" class="nav-link smooth-anchor"
                >Home <i class="icon-arrow-down"></i
              ></a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="#get-2" class="nav-link smooth-anchor">Services</a>
            </li>
          </ul>
              ...
              <div class="col-12 d-flex inner">
                <div class="left align-self-center text-center text-md-left">
                  ...
                  >
                    ...
                    Here will be cloudy days! But don't worry, only LYRA will rain!
                  </p>
                  <a
                    href="#contact"
                    data-aos="zoom-out-up"
    ...
    <!-- Get -->
    <section id="get" class="section-2 hero p-0 odd featured right">
      <div class="swiper-container no-slider animation slider-h-100">
        <div class="swiper-wrapper">
          <!-- Item 1 -->
          <div class="swiper-slide slide-center">
            ...
            <div class="slide-content row" data-mask-768="70">
              <div class="col-12 d-flex justify-content-end inner">
                <div class="right text-center text-md-right">
                  ...
                  >
                    Twitter Bot is running! follow us on twitter, put like, comment, quote @scryptachain and retweet and you will automatically receive LYRA.
                  </p>
                  <h5 style="color: #1E50BC">It is simple! Interact with our Twitter Post <br> $LYRA #scrypta #scryptachain and @scryptachain</h5>
    ...
    <!-- Get -->
    <section id="get-2" class="section-3 hero p-0 odd featured left">
      <div class="swiper-container no-slider animation slider-h-100">
        <div class="swiper-wrapper">
          <!-- Item 1 -->
          <div class="swiper-slide slide-center">
              ...
              <div class="col-12 d-flex inner">
                <div class="left align-self-center text-center text-md-left">
                  ...
                  <p
                    ...
                    class="description"
                  >
                    Do you have a talent and need help to be discovered? Count
                    on us in your evaluation.
                  </p>
                  <a
                    href="#contact"
                    data-aos="zoom-out-up"
            ...
            >
              ...
              <div class="row intro form-content">
                <div class="col-12 p-0">
                  ...
                  <!-- Step Title -->
                  <div class="step-title">
                    <h2 class="mb-0 super effect-static-text">Almost There</h2>
                    <p>
            ...
            <div class="col-12 col-lg-3 p-0">
              <div class="row">
                <div class="branding col-12 p-3 text-center text-lg-left item">
                  ...
                  <p>
                    Authentic and innovative.<br />Built to the smallest
                    detail<br />with a focus on usability<br />and performance.
                  </p>
                  ...
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        ><i class="icon-speech"></i>SEND A MESSAGE</a
                      >
                    </li>
                  </ul>
                </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-md-6 p-3 text-center text-lg-right">
              <p>
                © 2020 Leverage is Proudly Powered by
                <a href="https://codings.dev" target="_blank">Codings</a>.
              </p>
            </div>
          </div>
        </div>
